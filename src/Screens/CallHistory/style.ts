...
export const styles = StyleSheet.create({
    ...
    headerTitle: { fontSize: getFontSize(20), fontFamily: fontFamily.bold, color: COLORS.black, marginStart: hp(2) },
    list: { padding: hp(2) },
    callItem: {
        flexDirection: 'row',
        alignItems: 'center',
    ...
    userName: { fontSize: getFontSize(14), fontFamily: fontFamily.bold, color: COLORS.black },
